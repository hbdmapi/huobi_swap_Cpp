...
namespace HuobiSwap {
    ...
    WebSocketConnection::WebSocketConnection(
        ...
        this->subscriptionMarketUrl = this->subscriptionMarketUrl + host + "/swap-ws";
        this->subscriptionTradingUrl = "wss://";
        this->subscriptionTradingUrl = this->subscriptionTradingUrl + host + "/swap-notification";
    };
    ...
    void WebSocketConnection::onMessage(char* in, size_t len) {
        ...
        if (((json.containKey("status") && strcmp(json.getString("status"), "ok") != 0) && 
                !(json.containKey("op") && strcmp(json.getString("op"), "notify") == 0)) ||
    ...
    void WebSocketConnection::reConnect(int delayInSecond) {
        Log::WriteLog("[Sub][%d] Reconnecting after %d seconds later", connectionId, delayInSecond);
